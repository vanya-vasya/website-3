        ...
        <div className="container">
          <div className="page-title__inner">
            ...
            <div className="page-title__title-box">
              <p className="page-title__sub-title">Privacy Policy</p>
            ...
            <div className="career-page-top__single">
              <div className="career-page-top__content-box">
                <div className="career-page-top__content-box-two">
                  <h3 className="career-page-top__title-1">Privacy Policy</h3>
                  <p className="career-page-top__text-1 pt-8">
                    Welcome to Neuvisia.com! This Privacy Policy explains how we
                  ...
                  <ul className="career-page-top__points-list list-unstyled">
                    <li>
                      ...
                      <p>
                        ...
                        on Neuvisia.com, we may collect the following personal
                  ...
                  <h4 className="career-page-top__title-3">Data Security</h4>
                  ...
                  <h4 className="career-page-top__title-3">Your Rights</h4>
                  <ul className="career-page-top__points-list list-unstyled">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>
                  ...
                  <p className="career-page-top__text-1">
                    ...
                    Policy, please contact us at support@neuvisia.com.
                  </p>
                </div>
              </div>
            </div>
