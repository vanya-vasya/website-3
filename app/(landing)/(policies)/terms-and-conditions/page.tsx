        ...
        <div className="container">
          <div className="page-title__inner">
            ...
            <div className="page-title__title-box">
              <p className="page-title__sub-title">Terms and Conditions</p>
              <h3 className="page-title__title">Updated: Jan 23, 2025</h3>
            </div>
            ...
            <div className="career-page-top__single">
              <div className="career-page-top__content-box">
                <div className="career-page-top__content-box-two">
                  ...
                  <h4 className="career-page-top__title-3">Eligibility</h4>
                  ...
                  <h4 className="career-page-top__title-3">Registration</h4>
                  <p className="career-page-top__text-1">
                  ...
                  <h4 className="career-page-top__title-3">Free Generations</h4>
                  <p className="career-page-top__text-1">
                  ...
                  <ul className="career-page-top__points-list list-unstyled">
                    <li className="mt-[26px]">
                      ...
                      <p>Conversation: 1 generation per interaction</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Image Generation: 10 generations per image</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Video Generation: 20 generations per video</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Music Generation: 15 generations per music piece</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Speech Generation: 15 generations per speech piece</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Code Generation: 3 generations per code snippet</p>
                    </li>
                  </ul>
                  <p className="career-page-top__text-1 mt-[26px]">
                  ...
                  <h4 className="career-page-top__title-3">3. User Conduct</h4>
                  <p className="career-page-top__text-1">
                  ...
                  <ul className="career-page-top__points-list list-unstyled">
                    ...
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Distributing harmful or malicious software</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>
                  ...
                  <p className="career-page-top__text-1">
                    ...
                    property of the user who created it. Neuvisia.com does not
                    claim ownership rights to the generated content. You retain
                    all rights to use, distribute, and create derivative works
                    from the content you create. Neuvisia.com provides you with
                  ...
                  <p className="career-page-top__text-1">
                    To the fullest extent permitted by law, Neuvisia.com shall
                  ...
                  <p className="career-page-top__text-1">
                    You agree to indemnify and hold harmless Neuvisia.com, its
                  ...
                  <h4 className="career-page-top__title-3">9. Governing Law</h4>
                  <p className="career-page-top__text-1">
                    These Terms shall be governed by and construed in accordance
                    with the laws of the European Union, without regard to its
                    conflict of law principles.
                  </p>
                  <h4 className="career-page-top__title-3">10. Contact Us</h4>
                  <p className="career-page-top__text-1">
                    If you have any questions or concerns about these Terms,
                    please contact us at support@neuvisia.com.
                  </p>
                </div>
              </div>
            </div>
