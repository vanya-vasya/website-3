        ...
        <div className="container">
          <div className="page-title__inner">
            ...
            <div className="page-title__title-box">
              <p className="page-title__sub-title">Cookies Policy</p>
            ...
            <div className="career-page-top__single">
              <div className="career-page-top__content-box">
                <div className="career-page-top__content-box-two">
                  <h3 className="career-page-top__title-1">Cookies Policy</h3>
                  <p className="career-page-top__text-1 pt-8">
                    At Neuvisia.com, we use cookies to enhance your browsing
                  ...
                  <p className="career-page-top__text-1">
                    We use the following types of cookies on Neuvisia.com:
                  </p>
                  ...
                  <p className="career-page-top__text-1">We use cookies to:</p>
                  <ul className="career-page-top__points-list list-unstyled pt-4">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Ensure the website functions properly and securely</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>
                  ...
                  <ul className="career-page-top__points-list list-unstyled pt-4">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>Set your browser to block or delete cookies</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                      <p>
